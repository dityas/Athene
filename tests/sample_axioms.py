...
kinda_complicated_abox=ClassAssertion(kinda_complicated_axiom,Instance("Aditya"))
...
kinda_complicated_unsat_abox=ClassAssertion(kinda_complicated_unsat_axiom,Instance("Aditya"))
